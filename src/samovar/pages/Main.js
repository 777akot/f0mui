...
import swipeSteps from './content/SwipeSteps';
...
class Main extends Component {
  ...
  render() {
    ...
    const swipeSteps = this.state.swipeSteps;
        ...
        <div>
          <Grid container justify="center">
            ...
            <Grid container item xs={12}>
                ...
                <Grid item xs={12}>
                  <Paper>
                  <ContestMenu updateData={this.updateData} content={projectContent}/>
                    <div>
                      <div className={classes.paper}>

                        <Typography variant="h4" color='primary' gutterBottom>
                        {projectContent.slice(subContent,subContent + 1).map((item, index) => (
